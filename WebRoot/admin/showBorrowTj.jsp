                ...
                <div id="content">
                    ...
                    <div class="main" style="padding-top:30px;">
                    	<table class="table table-bordered" cellspacing="0" width="80%" align="center">
                    		...
                    		<% 
								List<Borrowtj> book = (List<Borrowtj>)request.getAttribute("borrowTj");
								if(book.isEmpty()) {
							 %>
							 	<tr>
									<td colspan="9"><font color="red">没有借阅记录</font></td>
								</tr>
							...
							<%
							 ...
							 %>	
	                    		<c:forEach items="${borrowTj}" var="b" varStatus="s">
                    	...
                    	<ul class="pager">
						    <li><a href="<%=request.getContextPath()%>/statisticsCl?flag=borrowTj&flag2=first">首页</a></li>
						    <li><a href="<%=request.getContextPath()%>/statisticsCl?flag=borrowTj&flag2=pre">&larr;上一页</a></li>
						    <li><a href="<%=request.getContextPath()%>/statisticsCl?flag=borrowTj&flag2=next">下一页&rarr;</a></li>
						    <li><a href="<%=request.getContextPath()%>/statisticsCl?flag=borrowTj&flag2=last">尾页</a></li>
						    <form action="statisticsCl?flag=borrowTj&flag2=define" method="post">
