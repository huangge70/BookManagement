            ...
            <div id="body">
                ...
                <div id="content">
                    ...
                    <div class="main" style="padding-top:30px;">
                    	<form action="<%=request.getContextPath()%>/recordCl?flag=search" method="post" name="myform">
                    	请输入书名：
                    	...
                    	<table class="table table-bordered" cellspacing="0" width="80%" align="center">
							...
							<%
							 ...
							 %>	
	                    		...
	                    		<form method="post" action="recordCl?flag=delete&id=${r.id}">
	                    		<tr>
	                    			<td>${r.id}</td>
	                    			<td>${r.username}</td>
	                    			<td>${r.name}</td>
                    	...
                    	<ul class="pager">
						    <li><a href="<%=request.getContextPath()%>/recordCl?flag=first">首页</a></li>
						    <li><a href="<%=request.getContextPath()%>/recordCl?flag=pre">&larr;上一页</a></li>
						    <li><a href="<%=request.getContextPath()%>/recordCl?flag=next">下一页&rarr;</a></li>
						    <li><a href="<%=request.getContextPath()%>/recordCl?flag=last">尾页</a></li>
						    <form action="recordCl?flag=define" method="post">
