...
<html>
 ...
 .footer {
  ...
  <body>
    <%
	 if ((String)request.getAttribute("addBookInfo")==("success")) {
	 %>
	 <script>
	   alert("新增图书成功！");
	 </script>
		...
		<div class="pageContainer">
		     ...
		     <div class="pageContent">
				...
				<div class="row-fluid">
                    	...
                    	<form action="bookManagement?flag=add" method="post" name="myform">
                    		<table class="table table-bordered table-hover">
                    			...
                    			<tr>
                    				<td>出版时间：</td>
                    				<td><input type="text" name="time" id="time"  maxlength="10" onfocus="$(this).calendar()" readonly></td>
                    			</tr> 
                    			<tr>
                    				<td>图书价格：</td>
