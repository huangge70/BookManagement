...
<html>
 ...
 .footer {
  ...
  <body>
  <%
	 if ((String)request.getAttribute("deleteBookInfo")==("success")) {
	 %>
	 <script>
	   alert("删除图书成功！");
	 </script>
            ...
            <div id="body">
                ...
                <div id="content">
                    ...
                    <div class="main" style="padding-top:30px;">
                    	<form action="<%=request.getContextPath()%>/adminSearchBook?flag=search" method="post" name="myform">
                    	请输入书名：
							...
							<%
							 ...
							 %>	
	                    		...
	                    		<tr>
	                    			...
	                    			<td>${b.price}</td>
	                    			<td>
	                    			  <button type="button" class="btn btn-warning" onclick="window.location.href('bookManagement?flag=search&id='+${b.id})" >修改</button>
                                      <button type="button" class="btn btn-danger" onclick="window.location.href('bookManagement?flag=delete&id='+${b.id})" >删除</button>	
	                    			</td>
                    	...
                    	<ul class="pager">
						    <li><a href="<%=request.getContextPath()%>/adminSearchBook?flag=first">首页</a></li>
						    <li><a href="<%=request.getContextPath()%>/adminSearchBook?flag=pre">&larr;上一页</a></li>
						    <li><a href="<%=request.getContextPath()%>/adminSearchBook?flag=next">下一页&rarr;</a></li>
						    <li><a href="<%=request.getContextPath()%>/adminSearchBook?flag=last">尾页</a></li>
						    <form action="adminSearchBook?flag=define" method="post">
